    ...
    project && (
      <div id="projectDetail" className="h-screen overflow-hidden !pt-10">
        <div className="gap-6 h-full">
          <div className="flex flex-col gap-10 md:gap-8 items-center w-screen pb-4 md:pb-10">
            <div className="flex flex-col  h-[4vh] items-baseline md:flex-row leading-tight text-center text-corpo-a md:text-2xl">
