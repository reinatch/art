...
const Sitemap = () => {
  ...
  return (
    <div
      ref={sitemapRef}
      id="sitemap"
      className={`pt-4 md:pt-10 px-4 md:px-10 flex flex-col items-start fixed h-[100dvh] md:max-h-[60vh] z-[100] md:pb-[12vh] bottom-0 w-full bg-white border-t-2 border-black gap-y-10 transform transition-transform duration-300 ease-in-out ${
